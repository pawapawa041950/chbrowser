...
{
    /// <summary>limits 省略時のデフォルト。doc §4.7。
    /// 既定 36 (= heavy 閾値 72 の半分。横断検索でも予算切れしにくいよう従来の 3 倍に拡大)。</summary>
    public static Limits Default { get; } = new(MaxToolCalls: 36, ScanBreadth.Single, ReadsFullThread: false);
}
